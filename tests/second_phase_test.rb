...
class SecondPhaseTests < Test::Unit::TestCase
  ...
  def test_ocr_with_foreign_elements
    #init the pso object
  ...
  def test_ocr_with_foreign_elements_recognition
    #init the pso object
    symbols_list = DeterministicAutomata.generate_symbols_list(4)
    states_count = 10
    ...
    pso = OcrPso.new(symbols_list, states_count, LEARNING_SET_FILEPATH, rejecting_states)
  ...
  def test_non_deterministic_ocr
    ...
    pso = NonDetOcrPso.new(symbols_list, states_count, LEARNING_SET_FILEPATH, non_det_val, rejecting_states)
  ...
  def test_non_det_with_foreign_elements_recognition
    #init the pso object
    symbols_list = DeterministicAutomata.generate_symbols_list(4)
    states_count = 10
